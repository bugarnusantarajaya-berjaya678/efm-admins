...
═══════════════════════════════════════ */
const ORDERS_DATA = [
  { id: '#B2B-26-0001', namaKlien: 'PT. Maju Bersama',          jenis: 'Corporate', program: 'Corporate Wellness',  nilaiKontrak: 'Rp 12jt/bln',  nilaiNum: 12_000_000, periode: 'Jun 2026–Jun 2027',  tanggalMulai: '2026-06-01', tanggalSelesai: '2027-06-01', tahapan: 'Class in Progress', status: 'Aktif',   pic: 'Admin EFM',  catatan: '', bulan: 'Jun', tahun: '2026' },
  { id: '#B2B-26-0002', namaKlien: 'Apartemen Green Lake',       jenis: 'Apartment', program: 'Apartment Fitness',   nilaiKontrak: 'Rp 8,5jt/bln', nilaiNum: 8_500_000,  periode: 'Jan 2026–Des 2026',  tanggalMulai: '2026-01-01', tanggalSelesai: '2026-12-01', tahapan: 'Contract',          status: 'Aktif',   pic: 'Admin EFM',  catatan: '', bulan: 'Jan', tahun: '2026' },
  { id: '#B2B-26-0003', namaKlien: 'CV. Teknologi Prima',        jenis: 'Corporate', program: 'Corporate Wellness',  nilaiKontrak: 'Rp 9jt/bln',   nilaiNum: 9_000_000,  periode: 'Mar 2026–Mar 2027',  tanggalMulai: '2026-03-01', tanggalSelesai: '2027-03-01', tahapan: 'MOU',               status: 'Pending', pic: 'Sales EFM', catatan: '', bulan: 'Mar', tahun: '2026' },
  { id: '#B2B-26-0004', namaKlien: 'Apartemen Sudirman Park',    jenis: 'Apartment', program: 'Apartment Yoga',      nilaiKontrak: 'Rp 6jt/bln',   nilaiNum: 6_000_000,  periode: 'Apr 2026–Apr 2027',  tanggalMulai: '2026-04-01', tanggalSelesai: '2027-04-01', tahapan: 'Quotation & LOI',   status: 'Pending', pic: 'Admin EFM',  catatan: '', bulan: 'Apr', tahun: '2026' },
  { id: '#B2B-26-0005', namaKlien: 'PT. Sinar Abadi',            jenis: 'Corporate', program: 'Corporate Wellness',  nilaiKontrak: 'Rp 15jt/bln',  nilaiNum: 15_000_000, periode: 'Feb 2026–Feb 2027',  tanggalMulai: '2026-02-01', tanggalSelesai: '2027-02-01', tahapan: 'Class in Progress', status: 'Aktif',   pic: 'Admin EFM',  catatan: '', bulan: 'Feb', tahun: '2026' },
  { id: '#B2B-26-0006', namaKlien: 'Apartemen The Residence',    jenis: 'Apartment', program: 'Apartment Fitness',   nilaiKontrak: 'Rp 7,5jt/bln', nilaiNum: 7_500_000,  periode: 'Mei 2026–Mei 2027',  tanggalMulai: '2026-05-01', tanggalSelesai: '2027-05-01', tahapan: 'Contract',          status: 'Aktif',   pic: 'Sales EFM', catatan: '', bulan: 'Mei', tahun: '2026' },
  { id: '#B2B-26-0007', namaKlien: 'PT. Global Tech',            jenis: 'Corporate', program: 'Executive Wellness',  nilaiKontrak: 'Rp 20jt/bln',  nilaiNum: 20_000_000, periode: 'Jun 2026–Jun 2027',  tanggalMulai: '2026-06-01', tanggalSelesai: '2027-06-01', tahapan: 'Quotation & LOI',   status: 'Pending', pic: 'Admin EFM',  catatan: '', bulan: 'Jun', tahun: '2026' },
  { id: '#B2B-26-0008', namaKlien: 'Apartemen Harbor Bay',       jenis: 'Apartment', program: 'Apartment Fitness',   nilaiKontrak: 'Rp 5jt/bln',   nilaiNum: 5_000_000,  periode: 'Jan 2026–Des 2026',  tanggalMulai: '2026-01-01', tanggalSelesai: '2026-12-01', tahapan: 'Selesai',           status: 'Selesai', pic: 'Admin EFM',  catatan: '', bulan: 'Jan', tahun: '2026' },
]
...
const KEGIATAN_INIT = {
  '#B2B-26-0001': [
    { id: 1, nama: 'Kunjungan Supervisor Bulanan',  vendor: 'Ahmad Pratama',          tglMulai: '05 Jul 2026', tglSelesai: '05 Jul 2026', tipe: 'Kunjungan/Supervisi',   status: 'Terjadwal' },
    { id: 2, nama: 'Perbaikan Treadmill & Alat',    vendor: 'TechFix Service Center',  tglMulai: '10 Jul 2026', tglSelesai: '11 Jul 2026', tipe: 'Maintenance/Perbaikan', status: 'Terjadwal' },
    { id: 3, nama: 'Penagihan Invoice Jul 2026',    vendor: 'Admin EFM',               tglMulai: '01 Jul 2026', tglSelesai: '01 Jul 2026', tipe: 'Penagihan',             status: 'Selesai'   },
    { id: 4, nama: 'Evaluasi Program Bulanan',      vendor: 'Sarah Jenkins',           tglMulai: '28 Jun 2026', tglSelesai: '28 Jun 2026', tipe: 'Meeting/Konsultasi',    status: 'Selesai'   },
    { id: 5, nama: 'Pengadaan Seragam Instruktur',  vendor: 'CV. Sportwear Jakarta',   tglMulai: '15 Jul 2026', tglSelesai: '20 Jul 2026', tipe: 'Lainnya',               status: 'Terjadwal' },
  ],
}
...
function OrderEditModal({ order, onClose }) {
  ...
  const [lineItems, setLineItems] = useState(() =>
    order.id === '#B2B-26-0001'
      ? [
          { id: 0, namaItem: 'Jasa Fitness Management',          satuan: 'Bulan', jumlah: 1, rate: 11_280_000 },
          { id: 1, namaItem: 'Biaya Operasional & Transportasi', satuan: 'Bulan', jumlah: 1, rate: 720_000 },
        ]
        ...
        <div className="overflow-y-auto px-6 py-6 space-y-8" style={{ maxHeight: '70vh' }}>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label>Jenis</Label>
                <FilterSelect value={form.jenis} onChange={v => updateForm('jenis', v)} options={['Corporate', 'Apartment']} className="w-full" />
              </div>
              <div>
                      ...
                      <td className="px-3 py-2">
                        <div className="flex items-center gap-1.5 flex-nowrap">
                          {row.status === 'Belum Ditagih' && (
                            <button
                              onClick={() => { onClose(); navigate(`/b2b/invoice?order=${orderId}&periode=${row.periode.replace(' ', '-')}&action=create`) }}
                          ...
                          {row.status === 'Invoice Terkirim' && (
                            <button
                              onClick={() => navigate(`/b2b/invoice?order=${orderId}&periode=${row.periode.replace(' ', '-')}`)}
                          ...
                          {row.status === 'Lunas' && (
                            <>
                              ...
                              <button
                                onClick={() => navigate(`/b2b/receipt?order=${orderId}&periode=${row.periode.replace(' ', '-')}`)}
...
export default function B2BOrdersPage() {
  ...
  const kpiPending   = ORDERS_DATA.filter(o => !['Contract','Class in Progress','Selesai'].includes(o.tahapan) && !['Selesai','Batal'].includes(o.status)).length
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-4 gap-4">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4">
            ...
            <p className="text-[11px] text-text-muted mt-1.5">Kontrak berjalan</p>
          </div>
          <div className="bg-white rounded-2xl border-2 border-[#1E1C43] px-5 py-4">
            ...
            <p className="text-[11px] text-text-muted mt-1.5">Per bulan (semua aktif)</p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 mb-4">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <select value={tahapanF} onChange={e => setTahapanF(e.target.value)}
              ...
              <option value="Class in Progress">Class in Progress</option>
            </select>
          ...
          <table className="w-full text-[13px]" style={{ minWidth: '1220px' }}>
            ...
            <tbody>
              {filtered.length === 0 ? (
                ...
                filtered.map(order => (
                  <tr key={order.id} onClick={() => navigate('/b2b/orders/' + order.id.replace('#', ''))} className="border-b border-gray-100 hover:bg-blue-50/30 transition-colors duration-150 cursor-pointer">
                    ...
                    <td className="px-3 py-2.5 text-xs font-normal text-gray-600">{order.program}</td>
                    <td className="px-3 py-2.5 text-xs font-normal text-gray-600 whitespace-nowrap">{order.nilaiKontrak}</td>
                    <td className="px-3 py-2.5 text-xs font-normal text-gray-600 whitespace-nowrap">{order.periode}</td>
