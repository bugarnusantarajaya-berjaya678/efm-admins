...
import PPKlienDetailPage from './pages/pp/PPKlienDetailPage'
...
import PPPromoFormPage from './pages/pp/PPPromoFormPage'
...
import EventQuotationPage from './pages/event/EventQuotationPage'
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/pp/klien/:id" element={<AppShell><PPKlienDetailPage /></AppShell>} />
      ...
      <Route path="/event/quotation"       element={<AppShell><EventQuotationPage       /></AppShell>} />
