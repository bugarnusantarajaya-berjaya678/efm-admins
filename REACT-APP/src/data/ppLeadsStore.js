...
export const ORDER_TO_LEAD_ID = {
  'PP-27-0002': 'LP-0019',  // Reza Putra (couple A)
  'PP-27-0003': 'LP-0020',  // Citra Anggraini (couple B)
  'PP-27-0004': 'LP-0021',  // Mega Wulandari (grup)
  ...
  'PP-26-0005': 'LP-0017',  // Dewi Rahayu
...
const LEADS_INIT = [
  ...
  { id:'LP-0003', nama:'Budi & Rina Santoso',   sapaan:'Kak', tipe:'Couple',   noHp:'085678901234', jenisKelamin:'', tanggalLahir:'', sumberLead:'Walk-in',    picEfm:'Sarah Jenkins', programDiminati:'12 Sesi - Pro',       emailUmum:'budi.santoso@email.com', alamat:'Jl. Pesanggrahan No. 45, Pesanggrahan, Jakarta Selatan',  catatanAwal:'Datang langsung ke lokasi, tertarik program couple',   statusPipeline:'Convert',  orderId:'PP-26-0008', tanggalMasuk:'6 Okt 2026',  tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0008', klienIds:['KL-0003','KL-0004'], hubunganDenganKlien: 'Pasangan', logAktivitas:[{status:'Convert',oleh:'Sarah Jenkins',tanggal:'10 Okt 2026',catatan:'Order berhasil dibuat, PP-26-0008'},{status:'Screening',oleh:'Sarah Jenkins',tanggal:'6 Okt 2026',catatan:'Dijadwalkan screening minggu depan'},{status:'New',oleh:'Sarah Jenkins',tanggal:'6 Okt 2026',catatan:'Walk-in langsung ke lokasi'}]},
  ...
  { id:'LP-0019', nama:'Reza Putra',             sapaan:'Mas', tipe:'Couple',   noHp:'081345678912', jenisKelamin:'Laki-laki',  tanggalLahir:'1989-06-20', sumberLead:'Referral',   picEfm:'Sarah Jenkins', programDiminati:'8 Sesi - Base',       emailUmum:'reza.putra@email.com',       alamat:'Jl. Tulodong Atas No. 8, Kebayoran Baru, Jakarta Selatan',     catatanAwal:'Referral dari rekan kantor, daftar couple bersama istri',    statusPipeline:'Convert',  orderId:'PP-27-0002', tanggalMasuk:'5 Jan 2027',  tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-27-0002', klienIds:['KL-0020','KL-0021'], hubunganDenganKlien:'Diri Sendiri', tipeProgram:'couple', logAktivitas:[{status:'Convert',oleh:'Sarah Jenkins',tanggal:'8 Jan 2027',catatan:'Order berhasil dibuat, PP-27-0002'},{status:'Closing',oleh:'Sarah Jenkins',tanggal:'7 Jan 2027',catatan:'Klien setuju paket couple 8 sesi Base'},{status:'Screening',oleh:'Sarah Jenkins',tanggal:'6 Jan 2027',catatan:'Screening awal dilakukan untuk Reza'},{status:'New',oleh:'Sarah Jenkins',tanggal:'5 Jan 2027',catatan:'Lead masuk dari referral rekan kantor'}]},
  { id:'LP-0020', nama:'Citra Anggraini',        sapaan:'Kak', tipe:'Couple',   noHp:'087812345678', jenisKelamin:'Perempuan',  tanggalLahir:'1987-08-16', sumberLead:'Walk-in',    picEfm:'Marcus Chen',   programDiminati:'12 Sesi - Pro',       emailUmum:'citra.anggraini@email.com',  alamat:'Jl. Cipinang Muara No. 27, Jatinegara, Jakarta Timur',          catatanAwal:'Mendaftarkan kedua orang tua lansia untuk program senior wellness', statusPipeline:'Convert', orderId:'PP-27-0003', tanggalMasuk:'6 Jan 2027',  tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-27-0003', klienIds:['KL-0022','KL-0023'], hubunganDenganKlien:'Orang Tua', tipeProgram:'couple', logAktivitas:[{status:'Convert',oleh:'Marcus Chen',tanggal:'9 Jan 2027',catatan:'Order berhasil dibuat, PP-27-0003'},{status:'Screening',oleh:'Marcus Chen',tanggal:'7 Jan 2027',catatan:'Screening kesehatan kedua orang tua selesai, ada kondisi khusus hipertensi'},{status:'New',oleh:'Marcus Chen',tanggal:'6 Jan 2027',catatan:'Walk-in langsung ke lokasi, anak mendaftarkan orang tua'}]},
  { id:'LP-0021', nama:'Mega Wulandari',         sapaan:'Kak', tipe:'Group',    noHp:'082298765432', jenisKelamin:'Perempuan',  tanggalLahir:'1993-11-05', sumberLead:'WhatsApp',   picEfm:'Dian Kartika',  programDiminati:'Fatloss & Bodyshape', emailUmum:'mega.wulandari@email.com',   alamat:'Jl. Terogong Raya No. 14, Cilandak, Jakarta Selatan',           catatanAwal:'Koordinator grup Zumba perumahan, 6 orang termasuk dirinya', statusPipeline:'Convert',  orderId:'PP-27-0004', tanggalMasuk:'7 Jan 2027',  tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-27-0004', klienIds:['KL-0024','KL-0025','KL-0026','KL-0027','KL-0028','KL-0029'], hubunganDenganKlien:'Diri Sendiri', tipeProgram:'grup', logAktivitas:[{status:'Convert',oleh:'Dian Kartika',tanggal:'10 Jan 2027',catatan:'Order berhasil dibuat, PP-27-0004'},{status:'Closing',oleh:'Dian Kartika',tanggal:'9 Jan 2027',catatan:'Grup setuju harga dan jadwal latihan'},{status:'Invoicing',oleh:'Dian Kartika',tanggal:'8 Jan 2027',catatan:'Invoice dikirim ke koordinator grup'},{status:'Screening',oleh:'Dian Kartika',tanggal:'8 Jan 2027',catatan:'Screening koordinator selesai'},{status:'New',oleh:'Dian Kartika',tanggal:'7 Jan 2027',catatan:'Lead masuk via WhatsApp, koordinator grup komunitas'}]},
]
