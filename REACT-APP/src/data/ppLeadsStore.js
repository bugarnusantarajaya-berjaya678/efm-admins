...
const LEADS_INIT = [
  { id:'LP-0001', nama:'James Wilson',          sapaan:'Pak', tipe:'Personal', noHp:'081234567890', sumberLead:'Website',    picEfm:'Sarah Jenkins', programDiminati:'12 Sesi - Pro',       emailUmum:'james.wilson@email.com',  catatanAwal:'Tertarik program fatloss, sudah follow up 2x',        statusPipeline:'Convert',  orderId:'PP-26-0013', tanggalMasuk:'20 Okt 2026', tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0013', logAktivitas:[{status:'Convert',oleh:'Sarah Jenkins',tanggal:'20 Okt 2026',catatan:'Order berhasil dibuat, PP-26-0013'},{status:'Closing',oleh:'Sarah Jenkins',tanggal:'18 Okt 2026',catatan:'Klien setuju paket 12 sesi'},{status:'Invoicing',oleh:'Sarah Jenkins',tanggal:'16 Okt 2026',catatan:'Invoice dikirim, menunggu pembayaran'},{status:'Screening',oleh:'Sarah Jenkins',tanggal:'14 Okt 2026',catatan:'Screening kesehatan selesai, BMI normal'},{status:'Approach',oleh:'Sarah Jenkins',tanggal:'12 Okt 2026',catatan:'Follow up via WhatsApp, klien tertarik'},{status:'New',oleh:'Sarah Jenkins',tanggal:'10 Okt 2026',catatan:'Lead masuk dari form website'}]},
  { id:'LP-0002', nama:'Dewi Ayu',              sapaan:'Kak', tipe:'Personal', noHp:'087766554433', sumberLead:'Referral',   picEfm:'Marcus Chen',   programDiminati:'Tennis',              emailUmum:'dewi.ayu@email.com',      catatanAwal:'Direferensikan oleh klien lama',                       statusPipeline:'Approach', tanggalMasuk:'7 Jun 2026',  tanggalFollowUp:'2026-07-03', catatan:'Belum respon follow up terakhir',   logAktivitas:[{status:'Approach',oleh:'Marcus Chen',tanggal:'1 Jul 2026',catatan:'Follow up kedua, belum ada respon'},{status:'New',oleh:'Marcus Chen',tanggal:'7 Jun 2026',catatan:'Lead masuk dari referral'}]},
  { id:'LP-0003', nama:'Budi & Rina Santoso',   sapaan:'Kak', tipe:'Couple',   noHp:'085678901234', sumberLead:'Walk-in',    picEfm:'Sarah Jenkins', programDiminati:'12 Sesi - Pro',       emailUmum:'budi.santoso@email.com',  catatanAwal:'Datang langsung ke lokasi, tertarik program couple',   statusPipeline:'Screening',tanggalMasuk:'6 Okt 2026',  tanggalFollowUp:'2026-07-05', catatan:'Menunggu jadwal screening kesehatan', logAktivitas:[{status:'Screening',oleh:'Sarah Jenkins',tanggal:'6 Okt 2026',catatan:'Dijadwalkan screening minggu depan'},{status:'New',oleh:'Sarah Jenkins',tanggal:'6 Okt 2026',catatan:'Walk-in langsung ke lokasi'}]},
  { id:'LP-0004', nama:'Rian Maulana (Group Tennis)',sapaan:'Mas',tipe:'Group',noHp:'087712345678',sumberLead:'Meta Ads',    picEfm:'Sarah Jenkins', programDiminati:'Tennis Group',         emailUmum:'rian.maulana@email.com',  catatanAwal:'Mau daftar grup 4 orang untuk tennis',                statusPipeline:'New',      tanggalMasuk:'15 Jun 2026', tanggalFollowUp:'2026-07-02', catatan:'Baru masuk, belum dihubungi',      logAktivitas:[{status:'New',oleh:'Sarah Jenkins',tanggal:'15 Jun 2026',catatan:'Lead masuk dari iklan Meta Ads'}]},
  { id:'LP-0005', nama:'Anita Kumar',           sapaan:'Kak', tipe:'Personal', noHp:'081298765432', sumberLead:'Meta Ads',    picEfm:'Sarah Jenkins', programDiminati:'Fatloss & Bodyshape', emailUmum:'anita.kumar@email.com',   catatanAwal:'Tertarik program fatloss',                            statusPipeline:'Lost',     tanggalMasuk:'15 Jun 2026', tanggalFollowUp:null, catatan:'Tidak melanjutkan karena budget',  logAktivitas:[{status:'Lost',oleh:'Sarah Jenkins',tanggal:'20 Jun 2026',catatan:'Klien menyatakan budget tidak sesuai'},{status:'Approach',oleh:'Sarah Jenkins',tanggal:'16 Jun 2026',catatan:'Sudah follow up, masih pertimbangan'},{status:'New',oleh:'Sarah Jenkins',tanggal:'15 Jun 2026',catatan:'Lead masuk dari iklan'}]},
  { id:'LP-0006', nama:'Emily Chen',            sapaan:'Kak', tipe:'Personal', noHp:'082345678901', sumberLead:'Meta Ads',    picEfm:'Sarah Jenkins', programDiminati:'Fatloss & Bodyshape', emailUmum:'emily.chen@email.com',    catatanAwal:'Tertarik fatloss program, butuh jadwal fleksibel',    statusPipeline:'Convert',  orderId:'PP-26-0012', tanggalMasuk:'12 Mar 2026', tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0012', logAktivitas:[{status:'Convert',oleh:'Sarah Jenkins',tanggal:'20 Mar 2026',catatan:'Order berhasil dibuat'},{status:'Closing',oleh:'Sarah Jenkins',tanggal:'18 Mar 2026',catatan:'Klien setuju paket'},{status:'New',oleh:'Sarah Jenkins',tanggal:'12 Mar 2026',catatan:'Lead masuk dari Meta Ads'}]},
  { id:'LP-0007', nama:'Kevin Hartanto',        sapaan:'Mas', tipe:'Personal', noHp:'081345678901', sumberLead:'Referral',   picEfm:'Marcus Chen',   programDiminati:'12 Sesi - Pro',       emailUmum:'kevin.hartanto@email.com',catatanAwal:'Direferensikan oleh James Wilson',                     statusPipeline:'Convert',  orderId:'PP-26-0004', tanggalMasuk:'18 Apr 2026', tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0004', logAktivitas:[{status:'Convert',oleh:'Marcus Chen',tanggal:'25 Apr 2026',catatan:'Order berhasil dibuat'},{status:'Screening',oleh:'Marcus Chen',tanggal:'22 Apr 2026',catatan:'Screening kesehatan selesai'},{status:'New',oleh:'Marcus Chen',tanggal:'18 Apr 2026',catatan:'Lead masuk dari referral'}]},
  { id:'LP-0008', nama:'Natasha Putri',         sapaan:'Kak', tipe:'Personal', noHp:'087811223344', sumberLead:'Instagram',  picEfm:'Sarah Jenkins', programDiminati:'Tennis',              emailUmum:'natasha.putri@email.com', catatanAwal:'Menemukan EFM dari Instagram, mau coba tennis',      statusPipeline:'Convert',  orderId:'PP-26-0001', tanggalMasuk:'22 Apr 2026', tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0001', logAktivitas:[{status:'Convert',oleh:'Sarah Jenkins',tanggal:'30 Apr 2026',catatan:'Order berhasil dibuat'},{status:'New',oleh:'Sarah Jenkins',tanggal:'22 Apr 2026',catatan:'Lead masuk dari Instagram DM'}]},
  { id:'LP-0009', nama:'Ahmad Fauzi',           sapaan:'Pak', tipe:'Personal', noHp:'081122334455', sumberLead:'Walk-in',    picEfm:'Marcus Chen',   programDiminati:'12 Sesi - Pro',       emailUmum:'ahmad.fauzi@email.com',   catatanAwal:'Datang langsung, sudah komitmen mulai bulan depan',   statusPipeline:'Convert',  orderId:'PP-26-0002', tanggalMasuk:'5 Mei 2026',  tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0002', logAktivitas:[{status:'Convert',oleh:'Marcus Chen',tanggal:'10 Mei 2026',catatan:'Order berhasil dibuat'},{status:'New',oleh:'Marcus Chen',tanggal:'5 Mei 2026',catatan:'Walk-in langsung ke lokasi'}]},
  { id:'LP-0010', nama:'Yoga Pratama',          sapaan:'Mas', tipe:'Group',    noHp:'087700112233', sumberLead:'Google Ads', picEfm:'Sarah Jenkins', programDiminati:'Tennis Group',         emailUmum:'yoga.pratama@email.com',  catatanAwal:'Ingin daftar grup 3 orang, jadwal weekend',           statusPipeline:'Invoicing',tanggalMasuk:'2 Jul 2026',  tanggalFollowUp:'2026-07-20', catatan:'Invoice sudah dikirim, menunggu konfirmasi pembayaran', logAktivitas:[{status:'Invoicing',oleh:'Sarah Jenkins',tanggal:'12 Jul 2026',catatan:'Invoice dikirim via WhatsApp'},{status:'Screening',oleh:'Sarah Jenkins',tanggal:'8 Jul 2026',catatan:'Screening group selesai'},{status:'New',oleh:'Sarah Jenkins',tanggal:'2 Jul 2026',catatan:'Lead masuk dari Google Ads'}]},
  { id:'LP-0011', nama:'Maya Indriati',         sapaan:'Kak', tipe:'Personal', noHp:'082233445566', sumberLead:'Website',    picEfm:'Marcus Chen',   programDiminati:'Fatloss & Bodyshape', emailUmum:'maya.indriati@email.com', catatanAwal:'Submit form website, tertarik program 8 sesi',        statusPipeline:'Closing',  tanggalMasuk:'10 Jul 2026', tanggalFollowUp:'2026-07-25', catatan:'Negosiasi harga, hampir deal',    logAktivitas:[{status:'Closing',oleh:'Marcus Chen',tanggal:'18 Jul 2026',catatan:'Diskusi paket, hampir sepakat'},{status:'Invoicing',oleh:'Marcus Chen',tanggal:'15 Jul 2026',catatan:'Draft invoice dikirim'},{status:'Screening',oleh:'Marcus Chen',tanggal:'13 Jul 2026',catatan:'Screening selesai, hasil baik'},{status:'New',oleh:'Marcus Chen',tanggal:'10 Jul 2026',catatan:'Lead dari form website'}]},
  { id:'LP-0012', nama:'Fiona Santika',         sapaan:'Kak', tipe:'Personal', noHp:'081988776655', sumberLead:'Referral',   picEfm:'Sarah Jenkins', programDiminati:'Tennis',              emailUmum:'fiona.santika@email.com', catatanAwal:'Referral dari teman, minat yoga dan tenis',           statusPipeline:'Convert',  orderId:'PP-26-0003', tanggalMasuk:'15 Agu 2026', tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0003', logAktivitas:[{status:'Convert',oleh:'Sarah Jenkins',tanggal:'22 Agu 2026',catatan:'Order berhasil dibuat'},{status:'New',oleh:'Sarah Jenkins',tanggal:'15 Agu 2026',catatan:'Lead masuk dari referral'}]},
  { id:'LP-0013', nama:'Robert Taylor',         sapaan:'Pak', tipe:'Personal', noHp:'081567890123', sumberLead:'Website',    picEfm:'Marcus Chen',   programDiminati:'12 Sesi - Pro',       emailUmum:'robert.taylor@email.com', catatanAwal:'Expat, mencari personal trainer profesional',         statusPipeline:'Convert',  orderId:'PP-26-0011', tanggalMasuk:'22 Sep 2026', tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0011', logAktivitas:[{status:'Convert',oleh:'Marcus Chen',tanggal:'28 Sep 2026',catatan:'Order berhasil dibuat'},{status:'New',oleh:'Marcus Chen',tanggal:'22 Sep 2026',catatan:'Lead dari form website'}]},
  { id:'LP-0014', nama:'Anita Suryani',         sapaan:'Kak', tipe:'Personal', noHp:'085599887766', sumberLead:'Meta Ads',    picEfm:'Sarah Jenkins', programDiminati:'Fatloss & Bodyshape', emailUmum:'anita.suryani@email.com', catatanAwal:'Tertarik fatloss, target 5 kg dalam 2 bulan',         statusPipeline:'Convert',  orderId:'PP-26-0010', tanggalMasuk:'1 Okt 2026',  tanggalFollowUp:null, catatan:'Sudah convert ke Order PP-26-0010', logAktivitas:[{status:'Convert',oleh:'Sarah Jenkins',tanggal:'8 Okt 2026',catatan:'Order berhasil dibuat'},{status:'New',oleh:'Sarah Jenkins',tanggal:'1 Okt 2026',catatan:'Lead masuk dari Meta Ads'}]},
]
