export const picList = [
  { id: 'PIC-001', inisial: 'SJ', nama: 'Sarah Jenkins',   warna: '#E05945', spesialis: 'PT. Pelatih Bersertifikat',  status: 'aktif',    area: 'Jakarta Selatan', klienAktif: 8,  totalSesi: 124, tglMulaiPks: '2024-01-15', tglHabisPks: '2025-01-15', noHp: '0812-1111-0001', catatan: 'Spesialis functional training, ISSA certified' },
  { id: 'PIC-002', inisial: 'MC', nama: 'Marcus Chen',     warna: '#2980B9', spesialis: 'PT. Bersertifikat FISAF',    status: 'aktif',    area: 'Jakarta Barat',   klienAktif: 6,  totalSesi: 98,  tglMulaiPks: '2024-03-01', tglHabisPks: '2025-03-01', noHp: '0813-2222-0002', catatan: 'Ahli strength & conditioning' },
  { id: 'PIC-003', inisial: 'ER', nama: 'Elena Rodriguez', warna: '#27AE60', spesialis: 'PT. Senior Trainer',         status: 'aktif',    area: 'Jakarta Pusat',   klienAktif: 10, totalSesi: 210, tglMulaiPks: '2023-06-01', tglHabisPks: '2024-06-01', noHp: '0814-3333-0003', catatan: 'Pengalaman 8 tahun, spesialis senior fitness' },
  { id: 'PIC-004', inisial: 'DK', nama: 'David Kim',       warna: '#8E44AD', spesialis: 'Strength & Conditioning',    status: 'cuti',     area: 'Jakarta Utara',   klienAktif: 0,  totalSesi: 76,  tglMulaiPks: '2024-02-01', tglHabisPks: '2025-02-01', noHp: '0815-4444-0004', catatan: 'Cuti melahirkan s/d Juli 2026' },
  { id: 'PIC-005', inisial: 'AP', nama: 'Ahmad Pratama',   warna: '#E67E22', spesialis: 'Yoga & Pilates',             status: 'aktif',    area: 'Jakarta Selatan', klienAktif: 7,  totalSesi: 143, tglMulaiPks: '2024-04-01', tglHabisPks: '2025-04-01', noHp: '0816-5555-0005', catatan: 'RYT-200 certified, spesialis prenatal yoga' },
  { id: 'PIC-006', inisial: 'RI', nama: 'Rina Indah',      warna: '#16A085', spesialis: 'Cardio & Zumba',             status: 'aktif',    area: 'Jakarta Barat',   klienAktif: 5,  totalSesi: 89,  tglMulaiPks: '2024-05-01', tglHabisPks: '2025-05-01', noHp: '0817-6666-0006', catatan: 'Zumba instructor lisensi internasional' },
  { id: 'PIC-007', inisial: 'BW', nama: 'Budi Wijaya',     warna: '#C0392B', spesialis: 'Functional Training',        status: 'aktif',    area: 'Jakarta Timur',   klienAktif: 9,  totalSesi: 167, tglMulaiPks: '2023-09-01', tglHabisPks: '2024-09-01', noHp: '0818-7777-0007', catatan: 'PKS akan habis Sept 2024' },
  { id: 'PIC-008', inisial: 'ND', nama: 'Nadia Dewi',      warna: '#2C3E50', spesialis: 'Therapeutic Exercise',       status: 'nonaktif', area: 'Jakarta Selatan', klienAktif: 0,  totalSesi: 45,  tglMulaiPks: '2023-01-01', tglHabisPks: '2024-01-01', noHp: '0819-8888-0008', catatan: 'Kontrak berakhir Januari 2024' },
]
