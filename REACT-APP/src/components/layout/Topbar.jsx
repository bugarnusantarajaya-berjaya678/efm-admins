...
const routeLabels = {
  ...
  '/event':             ['B2B Event', 'Dashboard'],
  '/event/dashboard':   ['B2B Event', 'Dashboard'],
  '/event/leads':       ['B2B Event', 'Leads'],
  '/event/konsultasi':  ['B2B Event', 'Konsultasi'],
  '/event/orders':      ['B2B Event', 'Orders'],
  '/event/kalender':    ['B2B Event', 'Kalender'],
  '/event/invoice':     ['B2B Event', 'Invoice'],
  '/event/receipt':     ['B2B Event', 'Receipt'],
