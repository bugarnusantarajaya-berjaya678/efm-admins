...
const routeLabels = {
  ...
  '/pp/program-db/jenis-program':    ['Private Program', 'Program DB', 'Jenis Program'],
  ...
  '/b2b/corporate':     ['B2B', 'Corporate'],
  '/b2b/apartment':     ['B2B', 'Apartment'],
  '/b2b/clients':       ['B2B', 'Clients'],
  '/b2b/survey':        ['B2B', 'Survei'],
  '/b2b/quotation':     ['B2B', 'Quotation'],
  '/b2b/documents':     ['B2B', 'Dokumen'],
  '/b2b/invoice':       ['B2B', 'Invoice'],
  '/b2b/receipt':       ['B2B', 'Receipt'],
  '/b2b/live-report':   ['B2B', 'Live Report'],
  '/event':             ['Event', 'Dashboard'],
  '/event/leads':       ['Event', 'Leads'],
  '/event/konsultasi':  ['Event', 'Konsultasi'],
  '/event/quotation':   ['Event', 'Quotation'],
  '/event/tracker':     ['Event', 'Tracker'],
  '/event/documents':   ['Event', 'Dokumen'],
